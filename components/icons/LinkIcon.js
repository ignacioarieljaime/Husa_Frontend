...
const LinkIcon = () => {
	return (
        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="link" class="svg-inline--fa fa-link fa-xl " role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" width={32}>
