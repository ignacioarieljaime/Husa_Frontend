			...
			<div className='tiny-banner container pb-20 py-md-20'>
				<article className='article'>
					...
					{/* <h2 className='mb-6 fs-3'>
						...
						where you place It In your room Is just as Important as all the
						features the TV comes with.
					</h2>
					<div>
						<p className='m-auto fs-base fw-normal text-muted'>
							Cliff Tan, the feng shui expert behind @dearmodern on TikTok and
