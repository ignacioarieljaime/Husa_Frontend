...
// const ExtendedWarrantyFailureStatus = ({
// 	data: {
// 		structure: { list }
// 	}
// }) => {
...
// export default ExtendedWarrantyFailureStatus
...
// 	useEffect(() => {
// 		if (!statusData?.invoice?.transaction) {
// 			getTransactionInterval()
// 		}
// 	}, [statusData])
...
// 												href='https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf'
// 												download={
// 													statusData?.product?.name + '- extended warranty card'
// 												}
// 												target='_blank'>
// 												<Download />
// 											</a>
