	...
	function Index128({pim,data}) {
	  ...
	  export async function getServerSideProps(context) {
			...
			let data = await axios
				.get(
					'https://imcxm.dev-api.hisenseportal.com/api/husa/getPageInfo/128'
				)
				.then(response => {
				...
				console.log('send pim request')
				 let pim = await axios
						.get(
							'https://impim.dev-api.hisenseportal.com/api/cms/getProduct/1002'
						)
						.then(response => {
