	...
	function Index144({pim,data}) {
	  ...
	  export async function getServerSideProps(context) {
			...
			let data = await axios
				.get(
					'https://imcxm.dev-api.hisenseportal.com/api/husa/getPageInfo/144'
				)
				.then(response => {
				...
				console.log('send pim request')
				 let pim = await axios
						.get(
							'https://impim.dev-api.hisenseportal.com/api/cms/getProduct/1014'
						)
						.then(response => {
