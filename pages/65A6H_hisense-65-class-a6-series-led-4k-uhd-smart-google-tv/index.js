	...
	function Index161({pim,data}) {
	    return (
			<Layout meta={[{"rel": "blank", "name": "generator", "content": "\"SilverStripe"}, {"rel": "http-equiv", "name": "Content-Type", "content": "\"text/html;"}, {"rel": "blank", "name": "description", "content": "'A6"}, {"rel": "property=\"og:site_name\"", "name": "property=\"og:site_name\"", "content": "\"Hisense"}, {"rel": "property=\"og:title\"", "name": "property=\"og:title\"", "content": "'Hisense"}, {"rel": "property=\"og:locale\"", "name": "property=\"og:locale\"", "content": "\"en_US\""}, {"rel": "property=\"og:type\"", "name": "property=\"og:type\"", "content": "\"website\""}, {"rel": "property=\"og:url\"", "name": "property=\"og:url\"", "content": "\"https://www.hisense-usa.com/tv-and-audio/televisions/all-tvs/65A6H_hisense-65-class-a6-series-led-4k-uhd-smart-google-tv\""}, {"rel": "property=\"og:image\"", "name": "property=\"og:image\"", "content": "\"https://assets.hisense-usa.com/assets/GalleryImages/Product/435/b187549d55/A6H-Reward.png\""}, {"rel": "property=\"og:description\"", "name": "property=\"og:description\"", "content": "'A6"}, {"rel": "http-equiv", "name": "X-UA-Compatible", "content": "\"IE=edge\""}, {"rel": "blank", "name": "viewport", "content": "\"width=device-width,"}, {"rel": "blank", "name": "apple-touch-fullscreen", "content": "\"yes\""}, {"rel": "blank", "name": "apple-mobile-web-app-capable", "content": "\"yes\""}]}>
	      		<section>
		  		 { data && <Header pim={pim} data={data[0]}/> } { data && <ProductInfoAndSliderBox pim={pim} data={data[1]}/> } { data && <ProductCategoryBox pim={pim} data={data[2]}/> } { data && <ProductImageBox pim={pim} data={data[3]}/> } { data && <ProductImageBox pim={pim} data={data[4]}/> } { data && <ProductImageBox pim={pim} data={data[5]}/> } { data && <ProductBigContent pim={pim} data={data[6]}/> } { data && <ProductImageBox pim={pim} data={data[7]}/> } { data && <ProductNewsBox pim={pim} data={data[8]}/> } { data && <ProductNewsBox pim={pim} data={data[9]}/> } { data && <ProductNewsBox pim={pim} data={data[10]}/> } { data && <ProductDetailsBox pim={pim} data={data[11]}/> } { data && <ProductReviewBox pim={pim} data={data[12]}/> } { data && <ProductFineMeInStore pim={pim} data={data[13]}/> } { data && <ProductResourceBox pim={pim} data={data[14]}/> } { data && <Subscribe pim={pim} data={data[15]}/> } { data && <Footer pim={pim} data={data[16]}/> }
				</section>
			</Layout>
	    )
	  }
	  ...
	  export async function getServerSideProps(context) {
			...
			let data = await axios
				.get(
					'https://imcxm.dev-api.hisenseportal.com/api/husa/getPageInfo/161'
				)
				.then(response => {
				...
				console.log('send pim request')
				 let pim = await axios
						.get(
							'https://impim.dev-api.hisenseportal.com/api/cms/getProduct/816'
						)
						.then(response => {
