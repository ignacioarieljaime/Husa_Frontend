	...
	return (
		<section>
			<div class='container spec-info-section'>
				<h2 class='text-muted fs-2 fw-normal mb-4'>4K ULED ™</h2>
				<h3 class='fs-5tx mb-20'>Sharper, smoother pictures</h3>
				<div class='row mb-20'>
				...
				<div class='row align-items-center'>
					...
					<div class='col-12 col-md-4 order-1 order-md-2 mb-10 mb-md-0'>
						<h4 class='fs-4 fw-bolder-700 mb-4'>ULED</h4>
						<p class='fs-6 fw-normal mb-4'>
